...
Harness.test({
    query: post.select(instance.functions.RTRIM(post.content)).order(instance.functions.RTRIM(post.content)),
    pg: {
...
Harness.test({
    query: post.select(instance.functions.RTRIM(post.content)).order(instance.functions.RTRIM(post.content).descending()),
    pg: {
