...
Harness.test({
    query: customer.select(instance.functions.YEAR(customer.metadata)),
    pg: {
...
Harness.test({
    query: customer.select(instance.functions.MONTH(customer.metadata)),
    pg: {
...
Harness.test({
    query: customer.select(instance.functions.DAY(customer.metadata)),
    pg: {
...
Harness.test({
    query: customer.select(instance.functions.HOUR(customer.metadata)),
    pg: {
...
Harness.test({
    query: customer.select(instance.functions.CURRENT_TIMESTAMP()),
    pg: {
...
Harness.test({
    query: instance.select(instance.functions.CURRENT_TIMESTAMP().plus(instance.interval({ hours: 1 }))),
    pg: {
...
Harness.test({
    query: instance.select(instance.functions.CURRENT_TIMESTAMP().minus(instance.interval({ years: 3 }))),
    pg: {
...
Harness.test({
    query: instance.select(instance.functions.CURRENT_TIMESTAMP().minus(instance.interval({ years: 3, months: 2 }))),
    pg: {
...
Harness.test({
    query: instance.select(instance.functions.CURRENT_TIMESTAMP().plus(instance.interval({ hours: 1, minutes: 20 }))),
    pg: {
...
Harness.test({
    query: instance.select(instance.functions.CURRENT_TIMESTAMP().plus(instance.interval({ hours: "sql'injection", minutes: 20 }))),
    pg: {
...
Harness.test({
    query: instance.select(
        instance.functions.CURRENT_TIMESTAMP().minus(instance.interval({ days: 1, hours: 5, minutes: "sql'injection" }))
    ),
    pg: {
...
Harness.test({
    query: instance.select(instance.functions.CURRENT_TIMESTAMP().minus(instance.interval({ years: 2, months: 5 }))),
    pg: {
