...
Harness.test({
    ...
    pg: {
        text:
            'SELECT "customer"."id" AS "id_alias", "customer"."name" AS "name_alias", "customer"."age" AS "age_alias", "customer"."income" AS "income_alias", "customer"."metadata" AS "metadata_alias" FROM "customer"',
        string:
            'SELECT "customer"."id" AS "id_alias", "customer"."name" AS "name_alias", "customer"."age" AS "age_alias", "customer"."income" AS "income_alias", "customer"."metadata" AS "metadata_alias" FROM "customer"'
    },
    sqlite: {
    ...
    oracle: {
        text:
            'SELECT "customer"."id" "id_alias", "customer"."name" "name_alias", "customer"."age" "age_alias", "customer"."income" "income_alias", "customer"."metadata" "metadata_alias" FROM "customer"',
        string:
            'SELECT "customer"."id" "id_alias", "customer"."name" "name_alias", "customer"."age" "age_alias", "customer"."income" "income_alias", "customer"."metadata" "metadata_alias" FROM "customer"'
    },
    params: []
...
Harness.test({
    query: instance.select('1').where('1=1'),
    pg: {
...
Harness.test({
    query: instance.select(post.select(post.id)),
    pg: {
...
Harness.test({
    query: instance.select(post.select(post.content).plus(post.select(post.content))),
    pg: {
...
Harness.test({
    query: post.select(instance.constant(4)),
    pg: {
...
Harness.test({
    query: post.select(post.id, instance.constant(4)),
    pg: {
...
Harness.test({
    query: post.select(instance.constant(4).as('col1')),
    pg: {
...
Harness.test({
    query: post.select(instance.constant(4).plus(5)),
    pg: {
...
Harness.test({
    query: post.select(instance.constant(4), instance.constant('abc'), instance.constant(true)),
    pg: {
...
Harness.test({
    query: post.select(instance.constant(1).sum()),
    pg: {
...
Harness.test({
    query: instance.select(post.select(post.id).as('column1')),
    pg: {
...
Harness.test({
    query: instance.select(post.select(post.count()).as('column1')),
    pg: {
...
Harness.test({
    query: instance.select(post.select(post.id).as('column1'), user.select(user.id).as('column2')),
    pg: {
